...
<head>
    ...
    <![endif]-->
    <script src="https://pagead2.googlesyndication.com/pub-config/r20160810/ca-pub-4495360934352473.js"></script></head>
                ...
                <li class="treeview active">
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="admin"><i class="fa fa-circle-o"></i>Data tables</a></li>
                    </ul>
                </li>
            </ul>
        </section>
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12">
                                <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">User name</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
